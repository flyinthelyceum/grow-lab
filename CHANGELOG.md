...
### Numbers
- Shell 2.6 lb of steel. **The head comes to about 10.4 lb** — carriage weldment 4.6, shell 2.6, heatsink ~2.5 (two modules at ~1.25 each), boards ~0.7 — against the 12.0 lb the mast and clamp were sized to. Still under budget. (Originally estimated ~12.6 lb with a guessed 4.7 lb heatsink.)
- Each LM301H + heatsink module calipered 2026-09-10: **15.5 × 1.575 × 0.525 in**; two modules side by side → **15.5 × 3.15 × 0.525 combined**. Much smaller than the original guesses (14 × 4 × 1). The shell clears the pair; the pending-measurement note is closed.
